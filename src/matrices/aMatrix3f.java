...
public class aMatrix3f {
    private float[][] matrix = new float[3][3];

    public aMatrix3f(float _m00, float _m01, float _m02,
    ...
    public aMatrix3f multiplyMatrix3f (aMatrix3f _matrix) {
        return new aMatrix3f((this.m00() * _matrix.m00()) + (this.m01() * _matrix.m10()) + (this.m02() * _matrix.m20()),
    ...
    public aMatrix3f addMatrix3f (aMatrix3f _matrix) {
        return new aMatrix3f((this.m00() + _matrix.m00()),
    ...
    public aMatrix3f subtractMatrix3f (aMatrix3f _matrix) {
        return new aMatrix3f((this.m00() - _matrix.m00()),
                            (this.m01() - _matrix.m01()),
                            (this.m02() - _matrix.m02()),
                            (this.m10() - _matrix.m10()),
    ...
    //region SETTERS
    public void setMatrix3f (aMatrix3f _matrix) {
