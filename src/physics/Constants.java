...
public class Constants {
    ...
    public static double getAvogadro() { return avogadro; }
    public static double getSpeedOfLight() { return speedOfLight; }
    public static double getPlancksConstant() { return plancksConstant; }
    public static double getBoltzmannConstant() { return boltzmannConstant; }
    public static double getFaradayConstant() { return faradayConstant; }
    public static double getElectronRestMass() { return electronRestMass; }
    public static double getProtonRestMass() { return protonRestMass; }
    public static double getNeutronRestMass() { return neutronRestMass; }
    public static double getElectronCharge() { return electronCharge; }
    public static double getEarthGravity() { return earthGravity; }
    public static double getGasConstant() { return gasConstant; }
}
